...
@Gooey(
       ...
       program_name='Mô phỏng giấu tin sử dụng kĩ thuật LSB', # Defaults to script name
       image_dir='C:/Users/Trung/Desktop/steganography-master[PRODUCT]/icon')       #Icon for the program

def main():
    # Construct the argument parse and parse the arguments
    #ap = argparse.ArgumentParser()
    ap = GooeyParser(description="Nguyễn Hoàng Trung - D9DTVT \nBỏ trống Đầu vào ảnh Thủy Vân sẽ tự động chuyển sang chế độ tách Thủy Vân")
    ap.add_argument("--input_image1", type=str, required=True, help="Đầu vào ảnh gốc (res/image1.jpg)", widget='FileChooser')
    ap.add_argument("--input_image2", type=str, required=False, help="Đầu vào ảnh Thủy Vân (res/image2.jpg)", widget='FileChooser')
    ap.add_argument("--output_image", type=str, required=True, help="Đầu ra (res/merged_image.png)", widget='FileChooser')
    args = ap.parse_args()
...
"""python steganography.py --input_image1 res/image1.jpg --input_image2 res/image2.jpg
--output_image res/merged_image.png

python steganography.py --input_image1 res/merged_image.png --output_image res/unmerged_image.png"""